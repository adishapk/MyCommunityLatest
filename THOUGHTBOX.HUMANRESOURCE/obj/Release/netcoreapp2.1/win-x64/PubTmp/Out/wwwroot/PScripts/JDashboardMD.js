$(document).ready(function () {
    ...
    accordcount("tbl_mark_approval_trans", "NIL2", "NIL", "NIL", "NIL", "requ_appby", "requ_type_id", "NIL", "NIL", "1", "Department Request", "NIL", "NIL", "requestapproval1", "Yes");
    //Accordion bucket table filling for jobcard pending
    accordbucketfillinnerjoin("Request No", "Request Date", "Title", "requesttable1", "/ApprovalRequest/ApprovalRequest?requestid=", "NIL1", "request_id", "request_code", "request_date", "request_title", "requ_appby", "requ_type_id", "jobc_jobstat", "1", "Department Request", "Pending", "tbl_mark_requests", "tbl_mark_approval_trans", "request_id", "request_id");
